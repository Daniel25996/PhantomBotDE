...
$(function() {
    ...
    $('#addextcom-button').on('click', function() {
        ...
        helpers.getModal('add-ext-command', 'Externen Befehl hinzufügen', 'Speichern', $('<form/>', {
            'role': 'form'
        })
        ...
        function() {
            ...
            socket.getDBValue('external_command_exists', 'externalCommands', commandName.val(), function(e) {
                ...
                if (e.externalCommands !== null) {
                    toastr.error('Externer Befehl konnte nicht hinzugefügt werden, da er bereits vorhanden ist.');
                    return;
                }
                ...
                socket.updateDBValues('external_command_add', {
                    ...
                    toastr.success('Externer Befehl !' + commandName.val() + ' erfolgreich hinzugefügt!');
                });
            });
        }).modal('toggle');
    });
