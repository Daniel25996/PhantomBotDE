...
$(function () {
    ...
    setTimeout(function () {
        ...
        socket.getDBValues('get_discord_logging_settings', {
            ...
            // Log channels
            $('#discord_logs_pubsub').append(getChannelSelector('twitch-mod-channel', 'Protokollierungskanal', '#logs', e['modLogChannel'],
                    'In welchem Kanal die Moderationsprotokolle gepostet werden sollen.', allowedChannelTypes));
