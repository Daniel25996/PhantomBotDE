    ...
    public boolean authenticate() {
        ...
        try {
            ...
            if (this.hasAccessToken) {
                com.gmt2001.Console.out.println("Authentfizeirt mit Twitter API");
            } else {
                com.gmt2001.Console.out.println("Fehler beim authentifizieren mit der Twitter API");
            }
    ...
    public String updateStatus(String statusString) {
        ...
        try {
            ...
            if (t != null && !t.getId().isBlank()) {
                ...
                com.gmt2001.Console.debug.println("Fehler");
            }
        } catch (Exception ex) {
            com.gmt2001.Console.err.printStackTrace(ex);
        }
    ...
    public String updateStatus(String statusString, String filename, String mediaType) {
        ...
        try {
            ...
            if (umr != null && umr.getMediaId().length() > 0) {
                ...
                com.gmt2001.Console.debug.println("Medien Fehler");
            }
        } catch (Exception ex) {
            com.gmt2001.Console.err.printStackTrace(ex);
        }
