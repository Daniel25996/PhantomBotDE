...
public class TwitchAuthorizationCodeFlow {
    ...
    private boolean refreshTokens(CaselessProperties properties, boolean bot, boolean api) {
        ...
        if (changed) {
            ...
            if (PhantomBot.instance() != null) {
                com.gmt2001.Console.debug.println("Gespeicherte oauth=" + PhantomBot.instance().getProperties().getProperty("oauth") + " refresh=" + PhantomBot.instance().getProperties().getProperty("refresh") + " oauthexpires=" + PhantomBot.instance().getProperties().getProperty("oauthexpires"));
                com.gmt2001.Console.debug.println("Gespeicherte apioauth=" + PhantomBot.instance().getProperties().getProperty("apioauth") + " apirefresh=" + PhantomBot.instance().getProperties().getProperty("apirefresh") + " apiexpires=" + PhantomBot.instance().getProperties().getProperty("apiexpires"));
    ...
    private boolean refreshAPIOAuth(CaselessProperties properties) {
        ...
        if (properties != null && properties.containsKey("apirefresh") && !properties.getProperty("apirefresh").isBlank()) {
            ...
            com.gmt2001.Console.debug.println("Aktualisieren übersprungen " + (properties != null ? "t" : "f") + (properties != null && properties.containsKey("apirefresh") ? "t" : "f")
