 ...
 */
(function () {
    var subMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'subscribeMessage', createDuoJson('(name) hat mit Stufe (plan) abonniert!', '(name) hat  mit Prime abonniert!'))),
            reSubMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'reSubscribeMessage', createSingleJson('(name) hat (months) Monate hintereinander mit Stufe (plan) abonniert!'))),
            giftSubMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'giftSubMessage', createSingleNPJson('(name) hat(recipient) ein Stufe (plan) Abo geschenkt!'))),
            giftAnonSubMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'giftAnonSubMessage', createSingleNPJson('Ein anonymer Zuschauer hat ein Stufe (plan) Abo an (recipient) verschenkt!'))),
            massGiftSubMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'massGiftSubMessage', createSingleNPJson('(name) hat (amount) Stufe (plan) Abos an zufällige Personen verschenkt!'))),
            massAnonGiftSubMessage = JSON.parse($.getSetIniDbString('subscribeHandler', 'massAnonGiftSubMessage', createSingleNPJson('Ein anonymer Zuschauer hat (amount) Stufe (plan) Abos an zufällige Personen verschenkt!'))),
