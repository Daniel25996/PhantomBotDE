 ...
 */
(function () {
    var subMessage = $.getSetIniDbString('subscribeHandler', 'subscribeMessage', '(name) hat abonniert!'),
            primeSubMessage = $.getSetIniDbString('subscribeHandler', 'primeSubscribeMessage', '(name) hat  mit Prime abonniert!'),
            reSubMessage = $.getSetIniDbString('subscribeHandler', 'reSubscribeMessage', '(name) hat (months) Monate hintereinander abonniert!'),
            giftSubMessage = $.getSetIniDbString('subscribeHandler', 'giftSubMessage', '(name) hat (recipient) ein Abo geschenkt!'),
            giftAnonSubMessage = $.getSetIniDbString('subscribeHandler', 'giftAnonSubMessage', 'Ein anonymer Zuschauer hat ein Abo an (recipient) verschenkt!'),
            massGiftSubMessage = $.getSetIniDbString('subscribeHandler', 'massGiftSubMessage', '(name) hat gerade (amount) Abo\'s an zufällige Personen verschenkt!'),
            massAnonGiftSubMessage = $.getSetIniDbString('subscribeHandler', 'massAnonGiftSubMessage', 'Ein anonymer Zuschauer hat (amount) Abo\'s an zufällige Personen verschenkt!'),
