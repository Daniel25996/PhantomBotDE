...
$.lang.register('customcommands.delete.usage', 'Verwendung: !delalias [Aliasname])');
...
$.lang.register('customcommands.404.no.commands', 'Es gibt keine benutzerdefinierten Befehle, fügen Sie eins mit "!addcom" hinzu.');
...
$.lang.register('customcommands.token.usage', 'Verwendung: !tokencom [Befehl] [Token] — WARNUNG: Dies sollte über die Bot-Konsole oder Web-Panel erfolgen. Wenn du das im Chat ausführst, kann jeder, der den Chat sieht, Ihre Informationen kopieren!');
...
$.lang.register('customcommands.botcommands.total', 'Insgesamte Seiten: $1 [Siehe auch: https://phantombot.github.io/PhantomBot/guides/#guide=content/commands/commands]');
