...
$.lang.register('bettingsystem.open.error', 'Du musst erst eine Gewinnoption für die letzte Wette angeben, bevor du eine Neue eröffnen kannst. Verwende: !bet close [Option]');
...
$.lang.register('bettingsystem.close.error.usage', 'Die Wette ist nun geschlossen! Warte auf Gewinnresultat. Verwende: !bet close [Gewinnoption]');
...
$.lang.register('bettingsystem.close.success.winners', 'Es haben $1 Personen die Wette gewonnen! Es wurde eine Gesamtsumme von $2 gewonnen, für die Leute, die ihr Wette auf $3 platziert haben!');
...
$.lang.register('bettingsystem.bet.betplaced', 'Du hast bereits eine Wette in der Höhe von $1, auf die Option $2, platziert.');
$.lang.register('bettingsystem.bet.null', 'Das ist keine gültige Wettoption.');
$.lang.register('bettingsystem.toggle.save', 'Wettresultate werden $1 nach Abschluss gespeichert.');
...
$.lang.register('bettingsystem.lookup.usage', 'Verwendung: !bet lookup [$1] - nutze _# nach dem Datum, wenn du mehrere Gewinnspiele am Tag machst.');
