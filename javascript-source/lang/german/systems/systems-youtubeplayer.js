...
$.lang.register('ytplayer.client.404', 'Der YouTube-Player wird derzeit nicht verwendet und Songanfragen sind deaktiviert!');
$.lang.register('ytplayer.playlist.404', 'Kann Playlist [$1] nicht finden!');
$.lang.register('ytplayer.announce.nextsong', '[\u266B] Läuft gerade [$1] Anforderer: $2');

$.lang.register('ytplayer.console.client.connected', '[\u266B] YouTube-Player ist verbunden! [\u266B]');
$.lang.register('ytplayer.console.client.disconnected', '[\u266B] YouTube-Player ist nicht verbunden! [\u266B]');

$.lang.register('ytplayer.songrequests.enabled', '[\u266B] Songanfragen sind aktiviert! [\u266B]');
$.lang.register('ytplayer.songrequests.disabled', '[\u266B] Songanfragen sind deaktiviert! [\u266B]');

$.lang.register('ytplayer.command.volume.get', 'Aktuelle Lautstärke des YouTube-Players: $1');
$.lang.register('ytplayer.command.volume.set', 'Setze YouTube Player Lautstärke auf: $1');
...
$.lang.register('ytplayer.command.ytp.togglecconly.enable', 'YouTube Player spielt nur von Creative Commons lizenzierte Songs ab.');
$.lang.register('ytplayer.command.ytp.togglecconly.disable', 'Der YouTube Player spielt alle lizenzierten Songs ab.');

$.lang.register('ytplayer.command.ytp.togglestealrefund.enable', 'Gestohlene Songs des YouTube Players werden den Nutzern zurückerstattet.');
$.lang.register('ytplayer.command.ytp.togglestealrefund.disable', 'Gestohlene Songs von YouTube Player werden den Nutzern NICHT zurückerstattet.');

$.lang.register('ytplayer.command.ytp.togglerandom.toggled', 'YouTube Player Playlist Zufallsauswahl wurde $1');
...
$.lang.register('ytplayer.command.playlist.delete.isdefault', 'Kann Standard-Playlist nicht löschen!');
...
$.lang.register('ytplayer.command.stealsong.other.success', '$1 hat den aktuellen Song zur Playlist "[$2]" hinzugefügt.');
...
$.lang.register('ytplayer.command.ytp.usage', 'Verwendung: !ytp [togglecconly | togglesongrequest | toggleannounce | delrequest | pause | volume | togglerandom | setrequestmax | setmaxvidlength | votecount | resetdefaultlist | clearcache]');

$.lang.register('ytplayer.command.wrongsong.success', 'Letzten Musikwunsch entfernt: [$1]');
...
$.lang.register('ytplayer.command.wrongsong.usage', 'Verwendung: !wrongsong user [Nutzer]. Ohne Angabe von [Nutzer], wird einfach dein letzte Musikwunsch gelöscht.');
...
$.lang.register('ytplayer.command.nextsong.usage', 'Verwendung: !nextsong [Indexnummer | next [n] | list [x-y]. Zeigt den nächsten Song oder Titel anhand der [Indexnummer] oder die nächsten [n] Songs oder einen Bereich der Liste [x-y].');
...
$.lang.register('ytplayer.command.importpl.file.success', 'Import abgeschlossen! Erfolgreich $1 Musiktitel importiert und hinzufügen von $2 Musiktitel(n) aus "$3" zur Playlist "$4" fehlgeschlagen.');
$.lang.register('ytplayer.command.importpl.file.success.plerror', 'Import Abgeschlossen! Erfolgreich $1 Songs importiert und $2 Songs konnten nicht von "$3" zur Playlist "$4" hinzugefügt werden. $5 Playlist(en) übersprungen.');
$.lang.register('ytplayer.command.importpl.file.404', 'Kann Datei "$1" nicht finden!');
$.lang.register('ytplayer.command.importpl.file.registry404', 'Liste "$1" wurde in der Datenbank nicht erstellt, versuche es erneut.');
$.lang.register('ytplayer.command.importpl.file.usage', 'Verwendung: !importpl file [Playlistname] [Dateiname]');

$.lang.register('ytplayer.blacklisted', 'Du wurdest auf die Blacklist, für die Verwendung des Musikwunsch-Features, gesetzt!');
$.lang.register('ytplayer.blacklist.usage', 'Verwendung: !ytp blacklistuser [add / remove]');
$.lang.register('ytplayer.blacklist.add.usage', 'Verwendung: !ytp blacklistuser add [Benutzername]');
...
$.lang.register('ytplayer.blacklist.404', 'Songtitel wurde auf die Blacklist gesetzt.');
