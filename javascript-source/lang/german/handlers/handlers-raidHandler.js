...
$.lang.register('raidhandler.usage', 'Verwendung: !raid [Nutzername] | !raid [toggle / lookup / setreward / setincomingmessage / setnewincomingmessage / setoutgoingmessage / setoutgoingmessagespam]');
$.lang.register('raidhandler.toggle.enabled', 'Raid-Benachrichtigungen wurden erfolgreich aktiviert.');
$.lang.register('raidhandler.toggle.disabled', 'Raid-Benachrichtigungen wurden erfolgreich deaktiviert.');
$.lang.register('raidhandler.reward.usage', 'Verwendung: !raid setreward [Menge]');
$.lang.register('raidhandler.reward.set', 'Raidbelohnung geändert zu: $1');
$.lang.register('raidhandler.inc.message.usage', 'Usage: !raid setincomingmessage [Nachricht] - Variablen: (username), (viewers), (url), (times) and (game)');
