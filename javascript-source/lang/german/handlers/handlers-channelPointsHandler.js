...
$.lang.register('channelpointshandler.giveall.current', 'Giveall Einlöse sind auf $1 registriert und Benutzer erhalten $2 Punkte für jede Einlösung. Zum ändern, benutze bitte "!channelpoints giveall [config / amount]"');
...
$.lang.register('channelpointshandler.emoteonly.usage', 'Verwendung: !channelpoints emoteonly [usage / config / duration / toggle]');
