...
(function() {
    var entries = [],
        ...
        raffleMessage = $.getSetIniDbString('raffleSettings', 'raffleMessage', 'Eine Verlosung ist noch offen! Gebe (keyword) ein, um teilzunehmen. Bisher haben sich (entries) Personen eingetragen.'),
