...
(function() {
    var cost = 0,
        ...
        raffleStatus = false,
        msgToggle = false,
        raffleMessage = $.getSetIniDbString('traffleSettings', 'traffleMessage', 'Eine Verlosung ist noch offen! Gebe !Tickets (Betrag) ein, um teilzunehmen. Bisher haben sich (entries) Personen eingetragen.'),
