...
(function () {
    var cost = 0,
            ...
            raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Eine Verlosung ist noch offen! Geben Sie !tickets (amount) ein, um teilzunehmen. Bisher haben sich (entries) Personen angemeldet.'),
