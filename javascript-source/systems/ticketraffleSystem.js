...
(function() {
    var cost = 0,
        ...
        raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Eine Verlosung ist noch offen! Gebe !Tickets (Betrag) ein, um teilzunehmen. Bisher haben sich (entries) Personen eingetragen.'),
